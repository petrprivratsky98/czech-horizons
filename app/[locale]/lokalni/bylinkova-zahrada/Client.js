...
export function BylinkoveZahradyClient({akce = []}) {
  ...
  const T = isEN ? {
    ...
    howToCards: [
      {icon:'🌿', title:'Smell & taste',    text:'Lean in and take a sniff, then taste a leaf straight from the planter.'},
      {icon:'✂️', title:'Pick some',        text:'Take a few leaves home for your kitchen.'},
      {icon:'🌱', title:'Pick gently',      text:'Take just a few leaves, not whole plants. Always leave the roots in the soil.'},
      {icon:'🙏', title:'Be considerate',   text:'Leave some for others — take only as much as you will actually use.'},
