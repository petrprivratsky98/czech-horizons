...
export const CAPITALS = [
  ...
  { lat: 33.59, lng: -7.61 },  // Rabat — Morocco already above, skip / use Casablanca for visual
  // Actually Rabat is already above, let me replace with Casablanca as visual marker
